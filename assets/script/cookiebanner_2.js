...
var cookieConsentSettings = {
    ...
    //   e.appendChild(this.utils.createTag("h4", "", t.settings.form_title)), e.appendChild(this.utils.createTag("p", "", t.settings.form_text));
      return (
        ...
        (t.buttonReject = document.querySelector(".form-choices li:first-child")),
        (t.buttonAccept = document.querySelector(".form-choices li:nth-child(2)")),
