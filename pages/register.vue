        ...
        <section>
            ...
            <form class="form" v-if="!success" method="post" @submit.prevent="register">
                ...
                <span data-field="First name *" class="form-field">
                    <input v-model="username" class="form-input" type="text" name="username" placeholder="First name *" maxlength="80" required>
                    <p>Luister vriend! Dit gaat zo niet werken hé!</p>
                </span>
                <span data-field="Emailadres *" class="form-field">
                    <input v-model="email" class="form-input" type="text" name="email" placeholder="Emailadres *" maxlength="80" required>
                ...
                <span data-field="Password *" class="form-field">
                    <input v-model="password" class="form-input" type="password" name="password" placeholder="Password *" required>
                    <p>Luister vriend! Dit gaat zo niet werken hé!</p>
                </span>
