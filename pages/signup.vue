        ...
        <section>
            ...
            <form action="" method="POST" class="form">
                ...
                <span data-field="First name *" class="form-field">
                    <input class="form-input" type="text" name="firstname" placeholder="First name *" maxlength="80">
                    <p>Luister vriend! Dit gaat zo niet werken hé!</p>
                </span>
                <span data-field="Emailadres *" class="form-field">
                    <input class="form-input" type="text" name="email" placeholder="Emailadres *" maxlength="80">
                ...
                <input class="submit button" type="submit" name="submit" placeholder="Verzenden">
            </form>
